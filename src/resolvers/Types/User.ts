...
export const User = {
	claims: async ({ id }: any, _args: any, context: Context) => getUserClaims(id, context),
	roles: ({ id }: any, _args: any, context: Context) => context.prisma.user({ id }).roles(),
	city: ({ id }: any, _args: any, context: Context) => context.prisma.user({ id }).city()
};
